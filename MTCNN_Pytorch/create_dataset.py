...
def dataset_config():
    ...
    parser.add_argument('--class_data_txt_path',
                        default='E://wider_face_data/wider_face_split/wider_face_split/wider_face_train_bbx_gt.txt',
                        type=str, help='the path of WILDER FACE .txt file')
    parser.add_argument('--class_data_dir', default='E:\\wider_face_data\\WIDER_train\\WIDER_train\\images',
    ...
    parser.add_argument('--landmark_data_txt_path',
                        default='E://wider_face_data/train/trainImageList.txt',
                        type=str, help='the path of CelebA .txt file')
    parser.add_argument('--landmark_data_dir', default='E://wider_face_data/train', type=str,
                        help='the dir of CelebA image file')
    parser.add_argument('--output_path', default='E://wider_face_data/Dataset', type=str,
    ...
    parser.add_argument('--p_net_data', type=str,
                        default='E://wider_face_data/Dataset/P_Net_dataset/P_Net_dataset.txt',
                        help='the path of .txt file including the training data path')
    parser.add_argument('--r_net_data', type=str,
                        default='E://wider_face_data/Dataset/R_Net_dataset/R_Net_dataset.txt',
                        help='the path of .txt file including the training data path')
    parser.add_argument('--o_net_data', type=str,
                        default='E://wider_face_data/Dataset/O_Net_dataset/O_Net_dataset.txt',
                        help='the path of .txt file including the training data path')
